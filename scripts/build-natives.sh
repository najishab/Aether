...
build_hev() {
  ...
  for abi in "${ABIS[@]}"; do
    ...
    for sym in \
      JNI_OnLoad \
      Java_com_najishab_aether_core_TProxyService_TProxyStartService \
      Java_com_najishab_aether_core_TProxyService_TProxyStopService \
      Java_com_najishab_aether_core_TProxyService_TProxyGetStats; do
