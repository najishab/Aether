 ...
 * natives onto com.najishab.aether.core.TProxyService. That coupled the
...
Java_com_najishab_aether_core_TProxyService_TProxyStartService(JNIEnv *env,
                                                                jclass clazz,
                                                                jstring config_path,
                                                                jint tun_fd)
{
...
Java_com_najishab_aether_core_TProxyService_TProxyStopService(JNIEnv *env, jclass clazz)
{
    (void)env;
    (void)clazz;
...
Java_com_najishab_aether_core_TProxyService_TProxyGetStats(JNIEnv *env, jclass clazz)
{
